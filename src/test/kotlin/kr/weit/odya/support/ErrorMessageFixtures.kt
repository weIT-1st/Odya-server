...
const val INVALID_EMAIL_ERROR_MESSAGE = "$TEST_INVALID_EMAIL: 올바른 이메일 형식이 아닙니다"

const val INVALID_PHONE_NUMBER_ERROR_MESSAGE = "$TEST_INVALID_PHONE_NUMBER: 올바른 휴대전화 형식이 아닙니다"
