...
const val DELETE_NOT_EXIST_PROFILE_ERROR_MESSAGE = "$TEST_PROFILE_WEBP: Object Storage에 존재하지 않는 파일입니다"
...
const val DELETE_NOT_EXIST_CONTENT_IMAGE_ERROR_MESSAGE = "$TEST_GENERATED_FILE_NAME: Object Storage에 존재하지 않는 파일입니다"

const val NOT_EXIST_COMMUNITY_ERROR_MESSAGE = "$TEST_NOT_EXISTS_COMMUNITY_ID : 존재하지 않는 커뮤니티입니다."
