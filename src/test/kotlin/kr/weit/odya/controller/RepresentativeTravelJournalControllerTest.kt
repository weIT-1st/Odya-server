                    ...
                    restDocMockMvc.get(targetUri) {
                        ...
                        createDocument(
                            ...
                            responseBody(
                                ...
                                "content[].content" type JsonFieldType.STRING description "여행 일지 내용" example response.content[0].content,
                                ...
                                "content[].isBookmarked" type JsonFieldType.BOOLEAN description "여행 일지 북마크 여부" example response.content[0].isBookmarked,
