alter index PLACE_REVIEW_FOREIGN_INDEX rename to PLACE_REVIEW_USER_ID_INDEX;

alter index REPORT_PLACE_REVIEW_FOREIGN_INDEX rename to REPORT_PLACE_REVIEW_PLACE_REVIEW_ID_INDEX;

alter index REPORT_PLACE_REVIEW_FOREIGN_INDEX_2 rename to REPORT_PLACE_REVIEW_USER_ID_INDEX;

alter index REPORT_TRAVEL_JOURNAL_FOREIGN_INDEX rename to REPORT_TRAVEL_JOURNAL_TRAVEL_JOURNAL_ID_INDEX;

alter index REPORT_TRAVEL_JOURNAL_FOREIGN_INDEX_2 rename to REPORT_TRAVEL_JOURNAL_USER_ID_INDEX;
