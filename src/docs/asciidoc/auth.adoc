...
operation::auth-controller-test/terms-list-success[snippets='http-request,response-fields,http-response']
...
operation::auth-controller-test/terms-get-success[snippets='http-request,path-parameters,response-fields,http-response']
