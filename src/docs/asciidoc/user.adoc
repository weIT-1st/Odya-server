...
operation::user-controller-test/update-email-fail-exist-email[snippets='http-request,request-headers,http-response,response-fields']

=== *2-4 실패 - 유효하지 않은 토큰*

operation::user-controller-test/update-email-fail-invalid-token[snippets='http-request,request-headers,http-response,response-fields']
