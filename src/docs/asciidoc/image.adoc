...
=== *2-5 실패 - 구글맵에 없는 장소 id*

operation::image-controller-test/set-life-shot-fail-not-exist-place-id[snippets='http-request,request-headers,path-parameters,request-body,http-response']
